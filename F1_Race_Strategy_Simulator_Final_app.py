...
with col4:
    if rain_option == "No Rain":
        ...
        condition_display = rain_option.replace(" Rain", "")
    ...
    with st.spinner(
        ...
        # ====================================================
            ...
            with r3:
                ...
                st.metric(
                    "Pit Stops",
                    best.get("pit_stops", max(0, len(best["actual_strategy"]) - 1))
                )
            ...
            for i, compound in enumerate(
                ...
                with strategy_cols[i]:
                    ...
                    st.markdown(f"## {tyre_name(compound)}")
                    st.caption(f"Compound code: {compound}")
